...
Atualmente, sou estudante de Análise e Desenvolvimento de Sistemas da Universidade UNISINOS (POA). Estou me qualificando em lógica de programação usando python e JAVA, assim como no paradigma de programação orientada à objetos com JAVA. Entre outras finalidades, uso o github para aprender com outros DEVs sobre técnicas e melhores práticas, além de exercitar o versionamento de código com GIT.
